...
Please read these guidelines before contributing to meziantou/Meziantou.NET.Sdk:
...
If you have questions about how to use meziantou/Meziantou.NET.Sdk, please open a GitHub issue.
...
- Check that new and updated code follows meziantou/Meziantou.NET.Sdk's existing code formatting and naming standard
- Run meziantou/Meziantou.NET.Sdk's unit tests to ensure no existing functionality has been affected
...
By contributing your code to meziantou/Meziantou.NET.Sdk you grant Gérald Barré a non-exclusive, irrevocable, worldwide,
